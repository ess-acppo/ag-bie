<ul>
    ...
    <li><a href="http://www.inaturalist.org/taxa/search?q=${tc?.taxonConcept?.nameString}">iNaturalist</a></li>
    <li><a href="http://www.google.com.au/search?q=${tc?.taxonConcept?.nameString}">Google search</a></li>
    <li><a href="http://scholar.google.com.au/scholar?q=${tc?.taxonConcept?.nameString}">Google scholar</a></li>
</ul>